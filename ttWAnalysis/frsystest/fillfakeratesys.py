##########################################################################
# python script to run the fillFakeRateSys executable via job submission #
##########################################################################
...
if __name__=='__main__':
  ...
  # parse arguments
  parser = argparse.ArgumentParser('Fill systematic histograms for fake rate')
  ...
  if args.frdir is None:
      raise Exception('ERROR: fake rate dir must be specified.')
  ...
  if args.runmode=='local':
    ...
    ct.submitCommandsAsCondorCluster( 'cjob_fillfakeratesys', commands,
