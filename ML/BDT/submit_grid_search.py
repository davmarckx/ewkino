...
for year in years:
    commands = []
    commands.append("python3.6 grid_search.py " + year)
submitCommandsAsCondorCluster('cjob_grid_search', commands, stdout=None, stderr=None, log=None,cpus=4, mem=2048, disk=10240,home=None,proxy=None,cmssw_version="CMSSW_10_6_28", jobflavour=None)
