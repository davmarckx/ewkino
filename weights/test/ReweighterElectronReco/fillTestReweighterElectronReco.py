##################################################
# a submitter for fillTestReweighterElectronReco #
##################################################
...
if __name__=='__main__':
    ...
    nevents = sys.argv[3]
    exe = './fillTestReweighterElectronReco'
    ...
    ct.submitCommandAsCondorJob( 'cjob_fillTestReweighterElectronReco', command )
