...
commands = []
for year in years: 
    commands.append("python3.6 gridsearch_ND.py " + year)

submitCommandsAsCondorCluster('cjob_gridsearch_ND', commands, stdout=None, stderr=None, log=None,cpus=8, mem=2048, disk=10240,home=None, proxy=None,cmssw_version="CMSSW_10_6_28",jobflavour=None)
