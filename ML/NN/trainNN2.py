...
# NN:    self.Linear1 = nn.Linear(11, 30)
#        self.Linear2 = nn.Linear(11, 25)
#        self.Bilinear = nn.Bilinear(30,25,30)
#        self.layers = nn.Sequential(
#          nn.Linear(30, 2),
#          nn.Sigmoid())
# NN2:   self.layers = nn.Sequential(
#        nn.Linear(11, 30),
#        nn.ReLU(),
#        nn.Linear(30, 5),
#        nn.ReLU(),
...
#def TrainNN2(X_train, y_train, X_test, y_test, weights_train, weights_test, classweight, dropval, learr, beta1, beta2, batchsize, epochs=15):
sNN = TrainNN2(X_train_norm, y_train, X_test_norm, y_test,weight_train,weight_test, classweight, dropval,learr,beta1, beta2, batchsize,status, epochs=epochs)
torch.save(sNN.state_dict(), '/user/dmarckx/ewkino/ML/models/trained_sNN+_' + "drop" + str(int(dropval*100)) + "_" + str(epochs) + "_" + str(learr) + "_(" + str(int(beta1*10)) + "," + str(int(beta2*10)) + ")" + str(batchsize)  + '.sav')
