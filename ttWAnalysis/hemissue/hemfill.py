################################################################
# python script to fill histograms for checking HEM15/16 issue #
################################################################
# documentation: https://hypernews.cern.ch/HyperNews/CMS/get/JetMET/2000.html
...
if __name__=='__main__':
  ...
  # parse arguments
  parser = argparse.ArgumentParser('Check HEM issue')
  ...
  selection_types = 'tight'

  # check if executable is present
  exe = '../analysis/runanalysis'
  ...
  if args.runmode=='local':
    ...
    ct.submitCommandsAsCondorCluster( 'cjob_hemfill', commands,
