...
epochs = 100
nr_events = -1
sparse = "fullyconnected"          #sparse,fullyconnected or loose
njobs = 4

for year in years:
    commands = []
    commands.append("python3.9 kfoldGNN.py " + str(dropval) + " " + str(regdropval) + " " + str(learr) + " " + str(beta1) + " " + str(beta2) + " " + str(batchsize) + " " + str(epochs) + " " + str(nr_events) + " " + str(year) + " " + sparse + " " + str(njobs))
submitCommandsAsCondorCluster('cjob_kfoldGNN', commands, stdout=None, stderr=None, log=None,
