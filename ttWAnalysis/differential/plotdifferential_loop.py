...
if __name__=='__main__':
  ...
  outputdirect = "~/public_html/EFT_study_newBDT/"
  ssdirbase = '../combine/datacards_EFTstudy_newBDT_{}'
  regions = {'signalregion_dilepton_inclusive': ssdirbase}# + 'dilepton', 
             #'signalregion_trilepton': ssdirbase + 'trilepton'}
  write_roots = False
  efts = ["EFTcQq83","EFTcQq81","EFTcQei","EFTcQl3i","EFTcQlMi","EFTcQq11","EFTcQq13","EFTcbW","EFTcpQ3","EFTcpQM","EFTcpt","EFTcptb","EFTctG","EFTctW","EFTctZ","EFTctei","EFTctlSi","EFTctlTi","EFTctli","EFTctp","EFTctq1","EFTctq8"]
