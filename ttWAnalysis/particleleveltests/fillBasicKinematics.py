#########################################################################
# python script to run the fillComparison executable via job submission #
#########################################################################
...
if __name__=='__main__':
  ...
  if args.runmode=='local':
    ...
    ct.submitCommandsAsCondorCluster( 'cjob_basickinematics', commands,
