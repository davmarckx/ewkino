...
years = ["all"]#['2016PreVFP','2016PostVFP','2017','2018', 'all']
lr = ["0.05"]#['0.005','0.01','0.05','0.05','0.05']
depths = ["3"]#['5','3','2','2','3'] 
n_estimators = ["4000"]#['3000','2000','3000','5000','4000']


commands = []
for i in range(len(years)):
    print("python3.9 ROC_multiclass.py " + years[i] + " " + lr[i] + " " + depths[i] + " " + n_estimators[i])
    commands.append("python3.9 ROC_multiclass.py " + years[i] + " " + lr[i] + " " + depths[i] + " " + n_estimators[i])

submitCommandsAsCondorCluster('cjob_ROC_multiclass', commands, stdout=None, stderr=None, log=None,
